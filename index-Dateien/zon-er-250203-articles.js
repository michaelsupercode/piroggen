            ...
            async function getEmbed(url) {
                ...
                if (embedHTML) {
                    ...
                    if (scriptTag) {
                        ...
                        scriptType = scriptTag.getAttribute('type');
                        scriptTag.remove();
        
                        var newTag = document.createElement('script');
                        newTag.innerHTML = scriptContent;
                        if (scriptSrc && scriptSrc.length > 0) {
                            newTag.src = scriptSrc;
                        }

                        if (scriptType && scriptType.length > 0) {
                            newTag.setAttribute('type', scriptType ? scriptType : '');
                        }
            ...
            if (section == window.Zeit.view.ressort && banners) {
                ...
                switch (banner) {
                    ...
                    case 'AT':
                        ...
                        break;
                    case 'DUV':
                        renderBanner(findGapForEmbed(), "https://static.zeit.de/administratives/embeds/zg-bundestagswahl-2025-analyse/2025-btw-abgeordnetenwatch-embed");
                        break;
                    case 'DS':
